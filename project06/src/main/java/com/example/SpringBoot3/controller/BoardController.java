...
public class BoardController {
    ...
    public String insert(Principal principal, ModelMap modelMap) {
    ...
    public String insert_save(Board board, BindingResult bindingResult, Model model, Principal principal){
